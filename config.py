...
# --- DISCORD ---
BEEHOUSE_TRADE_ALERTS_WEBHOOK_URL = os.getenv("BEEHOUSE_TRADE_ALERTS_WEBHOOK_URL")

# --- TRADABLE INSTRUMENT TOGGLES ---
TRADE_SETTINGS = {
    "FOREX": True, "STOCKS": False, "METALS": True,
    "INDICES": False, "CRYPTO": False, "COMMODITIES": True
}
...
VOLATILITY_MULT = {
    ...
    "INDICES": 2.0, "CRYPTO": 3.0, "COMMODITIES": 2.0
}
...
CATEGORY_MAP = {
    ...
    "XTI": "COMMODITIES", "XBR": "COMMODITIES"
}
